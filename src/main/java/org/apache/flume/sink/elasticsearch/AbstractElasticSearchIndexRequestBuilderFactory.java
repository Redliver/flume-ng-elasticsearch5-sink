...
public abstract class AbstractElasticSearchIndexRequestBuilderFactory
     ...
     * @param indexPrefix Prefix of index name to use -- as configured on the
     * sink
     ...
     *
     * @param indexRequest The (empty) ElasticSearch {@link IndexRequestBuilder}
     * to prepare
     * @param indexName Index name to use -- as per
     * {@link #getIndexName(String, long)}
